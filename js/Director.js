...
export class Director{
  ...
  isStrike(bird,pipe){
    ...
    //不撞上的条件
    if(bird.right<pipe.left || bird.bottom<pipe.top ||bird.left>pipe.right || bird.top>pipe.bottom){
      //小鸟的右边小于水管的左边 || 小鸟的下边小于水管的上边 ||小鸟的左边要大于水管的右边 || 小鸟的上边大于水管的下边
      strike = false;
    }
    return strike;
  }
